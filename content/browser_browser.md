...
- 站点隔离
  ...
  ![iframe 使⽤单独的渲染进程](../imgs/iframe%20使⽤单独的渲染进程.png)
...
- 第⼀步是配置 Performance
  ...
  ![Performance 配置⻚](../imgs/Performance%20配置⻚.png)
...
- 第三步就是⼈⼯分析报告⻚，并找出⻚⾯的性能瓶颈。
  ...
  ![Performance 的报告⻚](../imgs/Performance%20的报告⻚.png)
